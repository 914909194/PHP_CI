...
<div id="OSC_Banner">
    ...
    <div class="clear"></div>
	  ...
	  <div id="VisitorInfo">
		当前访客身份：
				<?php echo $_SESSION['NAME']; ?>[ <a href="user/index">退出</a> ]
				<span id="OSC_Notification">
			<a href="inbox.htm" class="msgbox" title="进入我的留言箱">你有<em>0</em>新留言</a>
																		>
	</div>
		<div id="SearchBar">
    		<form action="user/soso" method="POST">
				<input type="text" name='soso' placeholder="请输入搜索内容" />
...
foreach($data as $val){
 ?>
  	<li class="Blog" id="blog_24027">
		<h2 class="BlogAccess_true BlogTop_0"><a href="user/viewPost?id=<?php echo $val->BLOG_ID?>"><?php echo $val->TITLE ;?></a>
		</h2>
		<div class="outline">
			  <span class="time">发表于 <?php echo $val->ADD_TIME ;?></span>
			  <span class="catalog">分类: <a href="#"><?php echo $val->NAME ;?></a></span>
			  <span class="stat">统计: 1评/<?php echo $val->CLICK_RATE; ?>阅</span>
		...
		<div class="TextContent" id="blog_content_24027">
						<?php echo iconv_substr($val->CONTENT,0,10);?>...
			<div class="fullcontent">
				<a href="user/viewPost?id=<?php echo $val->BLOG_ID?>">阅读全文...</a>
			</div>
		</div>
	</li>
	<?php } ?>
...
<div class="catalogs SpaceModule">
  ...
  <ul class="LinkLine">
  	<?php 
  	 ...
  	 ?>
    	<li><a href="#"><?php echo $val->NAME; ?>(<?php echo $val->BLOG_COUNT; ?>)</a></li>
	<?php  
		}
	?>	
	  </ul>

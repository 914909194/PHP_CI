...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="user/clogin"  method="POST" style="float:left; width:620px;">
    ...
    <table>
    	...
    	<tr class="buttons">
    		<th>&nbsp;</th>
			<td>
    		<input value="现在登录" id="btn1" class="BUTTON SUBMIT" type="submit" />
        <!-- <button id="btn1" type="button" style="background:skyblue" >现在登录</button> -->
        <!-- <span id='btn1'>现在登录</span> -->
			</td>
    	</tr>
...
<!--   <script>
    $('#btn1').click(function(){
      ...
      var pass=$('#f_pwd').val();
      $.post('user/clogin',{'name':email,'pass':pass},function(data){
          if(data=='success'){

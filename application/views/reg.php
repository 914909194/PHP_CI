	...
	<table cellpadding="0" cellspacing="0">
    	<tbody><tr id="tr_email">
    		...
    		<td>
				...
				<span style="display: none; background:skyblue" id='show3'>&nbsp;邮箱可用</span>
				<span style="display: none; background:red" id='show4'>&nbsp;请输入正确邮箱</span>
...
<script src="images/getcity.js"></script><span class="nodisp">请选择您所在的地区</span></td>
    	...
    	<tr>
			...
			<span style="background:#40AA53" id='span1'>&nbsp;换一个图</span><span style="display: none; background:red" id='show'>&nbsp;验证码错误</span><span style="display: none; background:skyblue" id='show2'>&nbsp;验证码正确</span>
			</td>
    	</tr>
		<tr>
    		<th>&nbsp;</th>		
			<td>
			<img id="img_vcode" alt="..." src="captcha/<?php echo $data['filename'];?>" style="border: 2px solid rgb(204, 204, 204);" align="absmiddle">
...
<script>
	$("#span1").click(function(){
		$val=$(this).val();
		$.post('user/ajaxcheck',"val="+$val,function(data){
			var dataarr=data.split('-');
			var imgurl="captcha/"+dataarr[0];
			$('#img_vcode').attr('src',imgurl);
		},'text');
	})
	$('#f_vcode').blur(function(){
		$var=$(this).val();
		$.post('user/checkcode',"var="+$var,function(data){
